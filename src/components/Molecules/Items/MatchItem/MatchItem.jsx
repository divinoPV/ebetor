      ...
      <div className={`${styles['MatchItem__bet']}`}>
        ...
        <div className={`${styles['MatchItem__bet__action']}`}>
          ...
          <div className={`${styles['MatchItem__bet__action__buttons']}`}>
            ...
            <button className={alreadyBet?.team === opponent1?.id ? styles['MatchItem__bet__forThisTeam'] : ''}
                    disabled={authentication.coins === 0 || alreadyBet}
                    onClick={() => toBet(opponent1?.id)}
            >
              {opponent1?.name}
            </button>
            <button className={alreadyBet?.team === opponent2?.id ? styles['MatchItem__bet__forThisTeam'] : ''}
                    disabled={authentication.coins === 0 || alreadyBet}
